...
Cron notation is often confusing so assist in having clear logic and to make more advanced scheduling easier next we will
tae a look at job execution using a TaskScheduler.